...
export class TimelineComponent implements OnInit, AfterViewInit {
  ...
  constructor(private data: DataService, private elementRef: ElementRef, private router: Router, private localStorage: LocalStorageService) {
    // Read Prefereces
  ...
  ngAfterViewInit() {
    this.elementRef.nativeElement.querySelectorAll(".timeline-header").forEach(item => {
